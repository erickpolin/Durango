...
attach(ConcDurango) #this is for not writing the name of the data frame and the $ ever time

#Sort Conc according to INGCOR, FOLIOVIV, FOLIOHOG
ConcDurango<- orderBy (~+ing_cor+folioviv+foliohog, data=ConcDurango) #this give us the households sorted by total income

#Adding the values of the expansion FACTOR. The sum is 34 million, which is the number of households in the country.
tot_hogares<-sum(ConcDurango$factor,to.data.frame=TRUE)
...
ConcDurango$tam_dec<-tam_dec

# Creating Deciles of Income 

ConcDurango$MAXT<-ConcDurango$ing_cor #vamos a crear en esta base la variable MAXT que es una copia de la columna de ingresos

ConcDurango<-ConcDurango[with(ConcDurango, order(rank(MAXT))),]  #lo que hicimos aqu? fue reordenar la base con respecto a MAXT. Cosa que en realidad, ya estaba.

ConcDurango$ACUMULA<-cumsum(ConcDurango$factor) #aqu? creamos una variable de suma acumulada del FACTOR de viviendas.
...
for(i in 1:9)
{
  a1<-ConcDurango[dim(ConcDurango[ConcDurango$ACUMULA<tam_dec*i,])[1]+1,]$factor
  ConcDurango<-rbind(ConcDurango[1:(dim(ConcDurango[ConcDurango$ACUMULA<tam_dec*i,])[1]+1),],
                             ConcDurango[(dim(ConcDurango[ConcDurango$ACUMULA<tam_dec*i,])[1]+1):dim(ConcDurango[1])[1],])
  
  b1<-tam_dec*i-ConcDurango[dim(ConcDurango[ConcDurango$ACUMULA<tam_dec*i,])[1],]$ACUMULA
  ConcDurango[(dim(ConcDurango[ConcDurango$ACUMULA<tam_dec*i,])[1]+1),]$factor<-b1
  ConcDurango[(dim(ConcDurango[ConcDurango$ACUMULA<tam_dec*i,])[1]+2),]$factor<-(a1-b1)
}

#aqu? estamos creando otra variable de suma acumulada del n?mero de hogares
ConcDurango$ACUMULA2<-cumsum(ConcDurango$factor)
...
ConcDurango[(ConcDurango$ACUMULA2<=tam_dec),]$DECIL<-1
...
for(i in 1:9)
{
  ConcDurango[((ConcDurango$ACUMULA2>tam_dec*i)&(ConcDurango$ACUMULA2<=tam_dec*(i+1))),]$DECIL<-(i+1)
}

# a lo que le qued? cero (que es la ?ltima observaci?n), ponle el decil 10
ConcDurango[ConcDurango$DECIL%in%"0",]$DECIL<-10

setwd("C:/Users/Erick/Dropbox/GIC/GITHUB2018/GIC/Durango")
write.dbf(ConcDurango,file="ConcDurango2010.dbf")
...
setwd("C:/Users/Erick/Dropbox/GIC/GITHUB2018/GIC/Durango")
write.dbf(ConcDurango,file="ConcDurango2018.dbf")
...
#reading the data
setwd("C:/Users/Erick/Dropbox/GIC/GITHUB2018/GIC/Durango")
Conc2010<-read.dbf("ConcDurango2010.dbf",as.is = T)
...
write.dbf(c_DECIL_ES,file = "Durango por fuente por DECIL estimaciones 2010.dbf")
write.dbf(c_DECIL_SE,file = "Durango por fuente por DECIL errores standard 2010.dbf")
write.dbf(c_DECIL_CV,file = "Durango por fuente por DECIL CV 2010.dbf")
write.dbf(c_DECIL_LI,file = "Durango por fuente por DECIL LI 2010.dbf")
write.dbf(c_DECIL_ES,file = "Durango por fuente por DECIL LS 2010.dbf")
...
write.dbf(c_DECIL_ES,file = "Durango INDIGENA por fuente por DECIL estimaciones 2010.dbf")
write.dbf(c_DECIL_SE,file = "Durango INDIGENA por fuente por DECIL errores standard 2010.dbf")
write.dbf(c_DECIL_CV,file = "Durango INDIGENA por fuente por DECIL CV 2010.dbf")
write.dbf(c_DECIL_LI,file = "Durango INDIGENA por fuente por DECIL LI 2010.dbf")
write.dbf(c_DECIL_ES,file = "Durango INDIGENA por fuente por DECIL LS 2010.dbf")
...
write.dbf(c_DECIL_ES,file = "Durango NO por fuente por DECIL estimaciones 2010.dbf")
write.dbf(c_DECIL_SE,file = "Durango NO por fuente por DECIL errores standard 2010.dbf")
write.dbf(c_DECIL_CV,file = "Durango NO por fuente por DECIL CV 2010.dbf")
write.dbf(c_DECIL_LI,file = "Durango NO por fuente por DECIL LI 2010.dbf")
write.dbf(c_DECIL_ES,file = "Durango NO por fuente por DECIL LS 2010.dbf")
...
#reading the data
setwd("C:/Users/Erick/Dropbox/GIC/GITHUB2018/GIC/Durango")
Conc2018<-read.dbf("ConcDurango2018.dbf",as.is = T)
...
write.dbf(c_DECIL_ES,file = "Durango Ingresos por fuente por DECIL estimaciones 2018.dbf")
write.dbf(c_DECIL_SE,file = "Durango Ingresos por fuente por DECIL errores standard 2018.dbf")
write.dbf(c_DECIL_CV,file = "Durango Ingresos por fuente por DECIL CV 2018.dbf")
write.dbf(c_DECIL_LI,file = "Durango Ingresos por fuente por DECIL LI 2018.dbf")
write.dbf(c_DECIL_ES,file = "Durango Ingresos por fuente por DECIL LS 2018.dbf")
...
write.dbf(c_DECIL_ES,file = "Durango INDIGENA Ingresos por fuente por DECIL estimaciones 2018.dbf")
write.dbf(c_DECIL_SE,file = "Durango INDIGENA Ingresos por fuente por DECIL errores standard 2018.dbf")
write.dbf(c_DECIL_CV,file = "Durango INDIGENA Ingresos por fuente por DECIL CV 2018.dbf")
write.dbf(c_DECIL_LI,file = "Durango INDIGENA Ingresos por fuente por DECIL LI 2018.dbf")
write.dbf(c_DECIL_ES,file = "Durango INDIGENA Ingresos por fuente por DECIL LS 2018.dbf")
...
write.dbf(c_DECIL_ES,file = "Durango NO Ingresos por fuente por DECIL estimaciones 2018.dbf")
write.dbf(c_DECIL_SE,file = "Durango NO Ingresos por fuente por DECIL errores standard 2018.dbf")
write.dbf(c_DECIL_CV,file = "Durango NO Ingresos por fuente por DECIL CV 2018.dbf")
write.dbf(c_DECIL_LI,file = "Durango NO Ingresos por fuente por DECIL LI 2018.dbf")
write.dbf(c_DECIL_ES,file = "Durango NO Ingresos por fuente por DECIL LS 2018.dbf")
...
Deciles2010<-read.dbf("Durango por fuente por DECIL estimaciones 2010.dbf")
names(Deciles2010)[1]<-c("ingcor2010")

Deciles2018<-read.dbf("Durango Ingresos por fuente por DECIL estimaciones 2018.dbf")
...
deciles2010No<-read.dbf("Durango NO por fuente por DECIL estimaciones 2010.dbf")
names(deciles2010No)[1]<-c("No2010")

deciles2018No<-read.dbf("Durango NO Ingresos por fuente por DECIL estimaciones 2018.dbf")
...
deciles2010indigena<-read.dbf("Durango INDIGENA por fuente por DECIL estimaciones 2010.dbf")
names(deciles2010indigena)[1]<-c("Indigena2010")

deciles2018indigena<-read.dbf("Durango INDIGENA Ingresos por fuente por DECIL estimaciones 2018.dbf")
